...
const Footer = () => {
  return (
    <div className='px-16 py-20 bg-[#11334f]'>
      <div className='flex mb-10 lg:flex-row md:justify-between flex-col gap-10 justify-center'>  
        ...
        <div className='pt-4 flex-col flex gap-3'>
            ...
            <div className='flex items-center gap-3 mt-3'>
              ...
              <h4 className='text-lg text-[#eee]'>contact@uniconfort-meuble.com</h4>
            </div>
        </div>
        <div className='flex pt-4 flex-col gap-6'>
            ...
            <div className='flex items-center gap-8'>
               ...
               <a target='_blank' href="https://www.facebook.com/UniConfort.dz">
                 <BsFacebook size={40} className='text-[#eee]'/>
               </a>
               <a target='_blank' href="https://www.tiktok.com/@uniconfort">
                 <BsTiktok size={40} className='text-[#eee]'/>
               </a>
            </div>
        </div>
      </div> 
      <h2 className='pt-6 text-2xl border-t-[2px] border-[#eee] text-[#eee] text-center mt-8'>Copyright © 2023. All rights reserved to <span className='font-semibold'>Uniconfort</span></h2>
    </div>
  )
}
