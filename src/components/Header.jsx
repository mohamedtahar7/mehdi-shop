    ...
    <div>
      ...
      >
            ...
            <ul className="flex items-center gap-12">
              ...
              >
                <a className="relative group cursor-pointer">
                  <BsCart
                    className={`${
                      !activeNav ? "text-[#11334f]" : "text-white"
                    } transition`}
                    size={30}
                  />
                  <p
                    className={`absolute -top-3 -right-3 p-1 rounded-full text-sm ${
                      !activeNav
                        ? "bg-[#11334f] text-white"
                        : "text-[#11334f] bg-white"
                    } px-2 py-[0.125rem] transtition`}
                  >
                    {itemAmount}
                  </p>
                </a>
        ...
        <div className="lg:hidden flex items-center gap-6">
          {mobileNav ? (
            <CgClose
              ...
              size={40}
              className={`${
                activeNav ? "text-white" : "text-[#11334f]"
              } cursor-pointer`}
            />
          ) : (
            <FiMenu
          ...
          >
            <BsCart
              className={`${
                activeNav ? "text-white" : "text-[#11334f]"
              } group-hover:text-[#091a28] transition`}
              size={30}
            />{" "}
            <p className="absolute -top-3 -right-3 p-1 rounded-full text-sm bg-[#11334f] px-2 py-[0.125rem] group-hover:bg-[#091a28] transtition text-white">
              {itemAmount}
            </p>
          </a>
        </div>
        ...
        <div
          ...
          } overflow-auto h-[100vh] transition-all drop-shadow-lg lg:w-[35vw] 2xl:w-[25vw] w-[100vw] md:w-[40vw] sm:w-[50vw] bg-[#eee]`}
        >
          <div className="py-8 px-8 flex justify-between items-center text-[#11334f]">
            <h3 className="text-2xl font-medium text-[#11334f]">
          ...
          <h4 className="text-[#11334f] text-xl font-medium px-8 mb-3">
            {" "}
            Total : {total}.00 DA{" "}
          </h4>
          ...
          {itemAmount > 0 && (
            <div className="px-4 py-4 flex flex-col gap-3 absolute -bottom-50 left-0 right-0">
              <p
                className="w-full cursor-pointer py-4 px-2 text-center text-xl font-medium text-[#11334f] bg-[#fff]"
        ...
        <div
          className={`absolute ${
            mobileNav ? "top-28" : "-top-96"
          } right-7 transition-all duration-300 bg-[#11334f] py-8 px-6`}
        >
